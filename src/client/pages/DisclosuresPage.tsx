  ...
  return (
    <div className="page-content">
      ...
      <div style={{ maxWidth: 'var(--max-content-width)' }}>
        ...
        <p>Toxic Screens participates in the Amazon Services LLC Associates Program. This means that when you click on certain product links on this site and make a purchase, we may receive a commission. This comes at no additional cost to you.</p>
        ...
        <p>The content on Toxic Screens is for informational and educational purposes only. Nothing on this site constitutes medical advice, psychological advice, or professional guidance. The assessments on this site are educational tools, not clinical instruments.</p>
