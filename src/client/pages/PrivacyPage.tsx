  ...
  return (
    <div className="page-content">
      ...
      <div style={{ maxWidth: 'var(--max-content-width)' }}>
        ...
        <p>The Screen Age does not collect personal information unless you voluntarily provide it through our contact form. We do not require account creation or email sign-up to use any feature of this site, including assessments.</p>
        ...
        <p>The content on The Screen Age is for informational and educational purposes only. It is not intended to be a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition or your child's wellbeing.</p>

        <h2>Children's Privacy</h2>
        <p>The Screen Age does not knowingly collect personal information from children under 13. This site is designed for parents and caregivers.</p>
